    ...
    return (
        <div key={id} className="tasks__items-row">
            <div className="checkbox">
                <input checked={completed} onChange={onChangeCheckBox} id={`task-${id}`} type="checkbox" />
